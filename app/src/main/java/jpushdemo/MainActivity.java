...
public class MainActivity extends InstrumentedActivity implements OnClickListener{
	...
	// initialization JPush.If it has already been initialized,But did not log on successfully,A re-login is performed.
	private void init(){
	...
	public static final String MESSAGE_RECEIVED_ACTION = "jpushdemo.MESSAGE_RECEIVED_ACTION";
