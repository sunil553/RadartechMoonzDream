...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	private void setTag(){
		...
		//"," Separate multiple converted into Set
		...
		//Call the JPush API to set the tag
	...
	private void setAlias(){
		...
		//Call the JPush API to set Alias
		mHandler.sendMessage(mHandler.obtainMessage(MSG_SET_ALIAS, alias));
	}
	
	
	/**
	 *Set the notification prompt mode - the base properties
	 */
	private void setStyleBasic(){
		BasicPushNotificationBuilder builder = new BasicPushNotificationBuilder(PushSetActivity.this);
		builder.statusBarDrawable = R.drawable.launcher_icon;
		builder.notificationFlags = Notification.FLAG_AUTO_CANCEL;  //Set to automatically disappear when clicked
		builder.notificationDefaults = Notification.DEFAULT_SOUND; //Set to ring（ Notification.DEFAULT_SOUND）or vibration（ Notification.DEFAULT_VIBRATE）
	...
	/**
	 *Set the notification bar style - Define the notification bar
	 */
	private void setStyleCustom(){
		CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(PushSetActivity.this,R.layout.customer_notitfication_layout,R.id.navigation_icon, R.id.title, R.id.text);
		builder.layoutIconDrawable = R.drawable.launcher_icon;
